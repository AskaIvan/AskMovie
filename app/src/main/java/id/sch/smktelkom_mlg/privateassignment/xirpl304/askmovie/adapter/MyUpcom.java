...
public class MyUpcom extends RecyclerView.Adapter<MyUpcom.MyViewHolder> {
    public String url = "https://image.tmdb.org/t/p/w500";
    public String image;
    ArrayList<Results> mlist;
    UpcomFragment upcomFragment;
    Context context;
    private int lastposition = -1;

    public MyUpcom(UpcomFragment upcomFragment, ArrayList<Results> mlist, Context context) {
        this.mlist = mlist;
    ...
    @Override
    public MyUpcom.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(MyUpcom.MyViewHolder holder, int position) {
