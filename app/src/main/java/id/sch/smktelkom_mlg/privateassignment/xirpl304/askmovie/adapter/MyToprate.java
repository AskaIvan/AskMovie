...
public class MyToprate extends RecyclerView.Adapter<MyToprate.MyViewHolder> {
    public String url = "https://image.tmdb.org/t/p/w500";
    public String image;
    ArrayList<Results> mlist;
    ToprateFragment toprateFragment;
    Context context;
    private int lastposition = -1;

    public MyToprate(ToprateFragment toprateFragment, ArrayList<Results> mlist, Context context) {
        this.mlist = mlist;
        this.toprateFragment = toprateFragment;
        this.context = context;
    }

    @Override
    public MyToprate.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(MyToprate.MyViewHolder holder, int position) {
