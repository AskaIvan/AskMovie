...
import id.sch.smktelkom_mlg.privateassignment.xirpl304.askmovie.adapter.MyTask;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl304.askmovie.model.MessageEvent;
...
public class TaskFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        ...
        adapter = new MyTask(getActivity(), tasks);
