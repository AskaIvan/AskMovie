...
import id.sch.smktelkom_mlg.privateassignment.xirpl304.askmovie.adapter.MyUpcom;
...
public class UpcomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_upcom, container, false);

        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.rv_recycler_view_upcom);
        rv.setHasFixedSize(true);
        myUpcom = new MyUpcom(this, mlist, getContext());
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=83e9bd45d01bdec860110180bf6d664b&language=en-US&page=1";
