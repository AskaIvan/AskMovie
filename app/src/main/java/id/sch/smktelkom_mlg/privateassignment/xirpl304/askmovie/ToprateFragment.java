...
import id.sch.smktelkom_mlg.privateassignment.xirpl304.askmovie.adapter.MyToprate;
...
public class ToprateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.rv_recycler_view_toprate);
        rv.setHasFixedSize(true);
        myToprate = new MyToprate(this, mlist, getContext());
        rv.setAdapter(myToprate);
    ...
    private void downloadDataResource() {
        String url = "https://api.themoviedb.org/3/movie/top_rated?api_key=83e9bd45d01bdec860110180bf6d664b&language=en-US&page=1";
        ...
        GsonGetRequest<ResultsRespons> myRequest = new GsonGetRequest<ResultsRespons>
                (url, ResultsRespons.class, null, new Response.Listener<ResultsRespons>() {
                    ...
                    public void onResponse(ResultsRespons response) {
                        ...
                        myToprate.notifyDataSetChanged();
                    }
